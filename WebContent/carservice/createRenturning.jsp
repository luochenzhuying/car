...
<body>
	<div class="panel admin-panel">
		<div class="panel-head">
			<strong><span class="icon-pencil-square-o"></span> 生成汽车检查单</strong>
		</div>
		<div class="body-content">
			<form method="post" class="form-x" action="check/addCheck.do">
				<div class="form-group">
					<div class="label">
						<label></label>
					</div>
					<div>
						<label>第二步：生成汽车检查单</label>
					</div>
					<div>
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" readonly="readonly"
							name="checkId" value="${requestScope.checkId}" /> <input
							type="hidden" name="rentId"
							value="${requestScope.rentTable.tableId}" /><input type="hidden"
							name="carNumber" value="${requestScope.car.carNumber}" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
					...
					<div class="field">
						<input type="text" class="input w50" id="checkDate" name="checkDate"
							readonly="readonly" value="${requestScope.checkDate}" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" name="paying"
							data-validate="required:请输入赔费金额,plusdouble:只能输入正小数" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
					...
					<div class="field">
						...
						<c:if test="${requestScope.rentTable.rentFlag == 0}">
							<button class="button bg-main icon-check-square-o" type="submit" disabled="disabled">
								还车</button>
						</c:if>
	...
	<div class="panel admin-panel">
		<div class="panel-head">
			<strong><span class="icon-pencil-square-o"></span> 出租单状态</strong>
		</div>
		<div class="body-content">
			<form class="form-x">
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" name="returnDate"
							disabled="disabled" value="${requestScope.rentTable.returnDate}" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
